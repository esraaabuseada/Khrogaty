...
export default class App extends Component<Props> {
  ...
  state = { placesArray: [],title:"Find Places" ,loaded: 0 }
      ...
      return (
        <FlatList
          ...
          renderItem={({ item }) =>
            ...
            <Card key={item.id}>
              <CardItem style={{ flexDirection: "row" ,height:260}} button onPress={() => {
           ...
           this.props.navigation.navigate('Details', {id: item.id, title: item.title.rendered, image: item.better_featured_image.source_url, content: item.content.rendered})
                ...
                <Left>
                  <Image
                    style={{ width: '90%', height: 200, borderRadius: 10, marginBottom:40 }}
